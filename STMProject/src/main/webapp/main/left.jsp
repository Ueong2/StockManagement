...
<body>
    <div class="navigation">
        <ul>
            <li><a href="<%=request.getContextPath()%>/stkInOutList/listStk.jsp" target="right">재고 현황</a></li>
            ...
            <li><a href="listStk.jsp" target="right">입고 내역</a></li>
            <li><a href="listStk.jsp" target="right">출고 내역</a></li>
