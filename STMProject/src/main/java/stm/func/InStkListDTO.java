...
public class InStkListDTO {
	...
	public InStkListDTO(String inv_in_code, String item_code, String item_name, String job_charger,
...
///////////////////////// 여기까지 //////////////////////////
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		InStkListDTO other = (InStkListDTO) obj;
	...
	public String toString() {
		return "InStkListDTO [inv_in_code=" + inv_in_code + ", item_code=" + item_code + ", item_name=" + item_name
