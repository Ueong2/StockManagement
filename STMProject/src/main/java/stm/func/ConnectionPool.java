...
public final class ConnectionPool {
  ...
  static final String jdbcclass = "oracle.jdbc.OracleDriver";//"com.imaginary.sql.msql.MsqlDriver";   
...
throws SQLException {
  ...
  if (free.isEmpty()) {
    ...
    // None left, do we create more? maxCons <= 0 : maxCons 설정하지 않음.
